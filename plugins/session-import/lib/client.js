...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const STRINGS = {
      zh: {
        'settings.title': '导入会话',
        'settings.description': '只扫描近一个月内更新过的对话。已导入的会跳过。',
        'settings.source': '选择来源',
        'panel.import': '导入',
        'panel.importing': '导入中…',
        'panel.loading': '正在扫描…',
        'panel.empty': '近一个月内没有尚未导入的会话',
        'panel.done': '已导入 {imported} 条，跳过 {skipped} 条',
        'panel.failed': '，失败 {failed} 条',
        'panel.counts': '近一个月 {pending} 条新对话 · {workspaces} 个工作区',
        'panel.option': '{label}（{pending}）',
        'panel.error': '导入失败：{message}',
      },
      en: {
        'settings.title': 'Import sessions',
        'settings.description': 'Only conversations updated in the last 30 days are scanned. Already imported items are skipped.',
        'settings.source': 'Choose source',
        'panel.import': 'Import',
        'panel.importing': 'Importing…',
        'panel.loading': 'Scanning…',
        'panel.empty': 'Nothing in the last 30 days left to import',
        'panel.done': 'Imported {imported}, skipped {skipped}',
        'panel.failed': ', {failed} failed',
        'panel.counts': '{pending} new chats in the last 30 days · {workspaces} workspaces',
        'panel.option': '{label} ({pending})',
